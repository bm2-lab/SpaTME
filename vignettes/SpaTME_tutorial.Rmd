...
Creating an `STFeature` object, which serves as a container for identified ST features.
The STFeature object is initialized with positional data and cell abundance annotations.
```{r, include=T}
